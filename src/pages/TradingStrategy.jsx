...
import { ArrowLeft, TrendingUp, Target, Home, Sun, Moon } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto pr-2 pb-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            {/* 右側：檢查表 */}
            <div className={`lg:col-span-5 p-6 rounded-xl border flex flex-col h-fit lg:sticky lg:top-6
              ${isDark ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-gray-200'}`}>
