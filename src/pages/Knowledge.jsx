...
import { Home, Sun, Moon, BookOpen, BarChart2, Terminal, Check } from 'lucide-react';
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
              深度解析 CFD 與期貨規則差異，助您選擇最適合的戰場，避免踩坑違規。
            </p>
          </div>
          ...
          <div id="comparison" className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* CFD Box - Highlighted */}
              <div className="bg-gradient-to-br from-emerald-50 to-cyan-50 dark:from-emerald-900/20 dark:to-cyan-900/20 p-10 rounded-3xl border-2 border-emerald-500 dark:border-emerald-500 relative overflow-hidden shadow-2xl shadow-emerald-500/20">
                ...
                <div className="absolute top-4 right-4">
                  <div className="bg-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full">當前頁面</div>
                </div>
                <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 flex items-center gap-4 relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                    <BarChart2 size={28} />
                  </div>
                  CFD (差價合約)
                </h3>
                <ul className="space-y-6 text-slate-700 dark:text-slate-300 relative z-10">
                  <li className="flex items-start gap-4">
                    <div className="mt-1 bg-emerald-500/30 p-1 rounded-full border border-emerald-500/50"><Check className="text-emerald-600 dark:text-emerald-400" size={14} /></div>
              ...
              <div className="bg-gradient-to-br from-white to-slate-100 dark:from-[#111827] dark:to-[#0B1120] p-10 rounded-3xl border border-slate-200 dark:border-slate-800 relative overflow-hidden shadow-2xl">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-400 border border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.1)]">
                    <Terminal size={28} />
                  </div>
                  Futures (期貨)
                </h3>
                <ul className="space-y-6 text-slate-700 dark:text-slate-300">
                  <li className="flex items-start gap-4">
                    <div className="mt-1 bg-blue-500/20 p-1 rounded-full border border-blue-500/30"><Check className="text-blue-500" size={14} /></div>
          ...
          <div className="bg-white dark:bg-[#111827]/60 backdrop-blur-sm p-12 rounded-3xl border border-slate-200 dark:border-slate-800 text-center">
            <div className="w-24 h-24 bg-emerald-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-emerald-500/20">
